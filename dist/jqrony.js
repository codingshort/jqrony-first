/*!
 * jQrony @VERSION
 * jQrony is pure Javascript Library @VERSION
 * 
...
if ( window.localStorage.getItem && !window.localStorage.getItem("jqrony") ) {
   var msg = "jQrony @VERSION active on your Browser.";
...
jQrony.fn = jQrony.prototype = {
   ...
   // The current version of jQrony being use Latest: @VERSION
   version: version,
