/*!
 * Clazzer is pure Javascript HTMLEntity parser @VERSION
 * 
 * No Copyright JS Foundation and other contributors
 * No Released under the MIT any license
 * 
 * Author: PRO Modassir <codingmodassir@gmail.com>
...
Clazzer.prototype = {
   ...
   // The current version of Clazzer being use Latest: @VERSION
   version: version,
...
var _clazzer = window.Clazzer;

Clazzer.noConflict = function() {
   if ( window.Clazzer === Clazzer ) {
      window._clazzer = Clazzer;
   }
...
// Clazzer requires that there be a global window in Common-JS like environments
